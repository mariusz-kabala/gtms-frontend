  ...
  return (
    ...
    >
      <section className={styles.stage}>
        ...
        <img
          className={cx(styles.allegro, styles.icon)}
          src="/images/polandrock/allegro.png"
        />
        <img
          className={cx(styles.bankPodrozy, styles.icon)}
          src="/images/polandrock/bank_podrozy.png"
        />
        <img
          className={cx(styles.cocaCola, styles.icon)}
          src="/images/polandrock/cocacola.png"
        />
        <img
          className={cx(styles.kostrzynNadOdra, styles.icon)}
          src="/images/polandrock/kostrzyn_nad_odra.png"
        />
        <img
          className={cx(styles.lidl, styles.icon)}
          src="/images/polandrock/lidl.png"
        />
        <img
          className={cx(styles.logo, styles.icon)}
          src="/images/polandrock/logo.png"
        />
        <img
          className={cx(styles.play, styles.icon)}
          src="/images/polandrock/play.png"
        />
        <img
          className={cx(styles.video, styles.icon)}
          src="/images/polandrock/video.png"
        />
        <img
          className={cx(styles.vlogJurka, styles.icon)}
          src="/images/polandrock/vlog_jurka.png"
        />
        <img
          className={cx(styles.zakonczenie, styles.icon)}
          src="/images/polandrock/zakonczenie.png"
        />
        <img
          className={cx(styles.zarazBedzieCiemno, styles.icon)}
          src="/images/polandrock/zaraz_bedzie_ciemno.png"
        />
        <img
          className={cx(styles.zarazBedzieCzysto, styles.icon)}
          src="/images/polandrock/zaraz_bedzie_czysto.png"
        />
        ...
        <div className={styles.sky}>
          ...
          <div
            ...
            style={{
              backgroundImage: `url('/images/polandrock/twinkling.png')`,
            }}
          />
        </div>
      </section>
